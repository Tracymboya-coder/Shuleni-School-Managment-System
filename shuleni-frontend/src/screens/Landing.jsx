      ...
      alignItems: 'center'
        ...
        <div>
          ...
          marginBottom: 22
            ...
            <ShieldCheck size={12} color="#2D6A4F" strokeWidth={2.5} />
            <span style={{
            fontSize: 12,
            fontWeight: 700,
            color: '#1A4A35'
          }}>Each school. Completely isolated.</span>
          </div>
          <h1 style={{
          fontFamily: "'Plus Jakarta Sans', sans-serif",
        ...
        position: 'relative'
          ...
          border: '1px solid #E4DDD4'
            ...
            <img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&h=400&fit=crop&auto=format" alt="Students in a classroom" style={{
            width: '100%',
            display: 'block'
          }} />
          </div>
      ...
      padding: '60px 40px'
        ...
        margin: '0 auto'
          ...
          marginBottom: 40
            ...
            fontSize: 15,
            color: '#6B6259'
          }}>Each role sees only what they're authorised to access.</p>
          </div>
          <div style={{
          display: 'grid',
      ...
      padding: '70px 40px'
        ...
        alignItems: 'center'
          ...
          aspectRatio: '4/3'
            ...
            <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=560&h=420&fit=crop&auto=format" alt="Teacher with students" style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover'
          }} />
